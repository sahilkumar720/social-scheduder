    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {accounts.map((account, index)=>{
            ...
            return (
                ...
                <button onClick={()=>handleDisconnect(account._id)} title="Disconnect account" className="ml-2 p-1.5 rounded-lg text-slate-300 group-hover:text-brand transition-all">
